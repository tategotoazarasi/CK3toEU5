...
namespace CK3 {
	...
	private:
		...
		std::vector<std::pair<long long, std::shared_ptr<Title> > > domain;
		// These are all titles owned (b-c-d-k-e), landless included. First one is PRIMARY.
	};
} // namespace CK3
