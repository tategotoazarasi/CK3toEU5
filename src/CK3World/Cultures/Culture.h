...
namespace CK3 {
	...
	private:
		...
		// this can be anything - user input or localized name in a particular language game is running.
		std::string           heritage; // all cultures should have this.
		std::set<std::string> nameLists;
		// We use these to generate dynamic culture code names, in lack of a better solution.
		...
		std::string name;
		// calculated value from all of the above - can be either *eu4* culture, ck3 vanilla, or anything in between.
	};
} // namespace CK3
