...
namespace mappers {
	...
	public:
		...
		[[nodiscard]] std::shared_ptr<CultureGroupDefinition> getCultureGroupForCultureName(
	...
	private:
		...
		void assignCultureToCultureGroup(const std::shared_ptr<CK3::Culture> &     sourceCulture,
										 const std::shared_ptr<CultureDefinition> &targetDefinition);
